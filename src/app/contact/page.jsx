...
export default function ContactPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await emailjs.send(
        'service_usb1k76', // Replace with your EmailJS service ID
        'template_j3fmwrj', // Replace with your EmailJS template ID
        templateParams,
        'hckOrioOZtyfvKEF7' // Replace with your EmailJS public key
      );
