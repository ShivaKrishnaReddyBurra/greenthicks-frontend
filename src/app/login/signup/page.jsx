...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-[#f8f9f3] px-4 py-10">
      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <motion.div
            ...
            className="mb-6"
          >
            <Image src={logo.src} alt="Green Thicks" width={100} height={100} className="mx-auto" />
          </motion.div>
        ...
        >
          <div className="relative">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-2 bg-[#f8f9f3] text-gray-500">Or sign up with</span>
            </div>
          </div>
        ...
        >
          ...
          <Link href="/login/login" className="font-medium text-[#2e7d32] hover:underline">
            Sign in
          </Link>
        </motion.p>
      </div>
