...
// Add other utility functions for products
...
export function getProductsByIdsAndCategory(ids, category) {
  return products.filter(
    (product) => ids.includes(product.id) && product.category === category
  )
}