    ...
    <div className="flex h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <aside className="hidden md:flex md:w-64 md:flex-col">
        <div className="flex flex-col flex-grow pt-5 overflow-y-auto bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700">
          ...
          <div className="p-4 border-t border-gray-200 dark:border-gray-700">
            <button className="flex items-center w-full px-4 py-2 text-sm font-medium text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-md transition-all duration-200">
      ...
      <div className={`fixed inset-0 z-40 md:hidden ${sidebarOpen ? "block" : "hidden"}`}>
        ...
        <div className="fixed inset-y-0 left-0 flex flex-col z-40 w-full max-w-xs bg-white dark:bg-gray-800 shadow-xl">
          ...
          <div className="p-4 border-t border-gray-200 dark:border-gray-700">
            <button className="flex items-center w-full px-4 py-2 text-base font-medium text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-md transition-all duration-200">
              <LogOut className="mr-3 h-5 w-5 text-gray-400 dark:text-gray-500" />
              Sign out
            </button>
          </div>
